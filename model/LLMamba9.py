...
class LLFormer(nn.Module):
    def __init__(self,
        ...
        self.patch_embed1 = OverlapPatchEmbed(inp_channels, dim, patch_size=16)
        self.patch_embed2 = OverlapPatchEmbed(inp_channels, dim, patch_size=2)
        self.patch_embed3 = OverlapPatchEmbed(dim, dim, patch_size=16)
        ...
        self.resize1 = Resize(in_dim=dim, scale=16)
