...
class LLFormer(nn.Module):
    def __init__(self,
        ...
        self.resize1 = Resize(in_dim=dim, scale=8)
        self.resize2 = Resize(in_dim=dim, scale=2)
        self.resize3 = Resize(in_dim=dim, scale=8)
        self.resize4 = Resize(in_dim=dim, scale=2)
    ...
    def forward(self, inp_img):
        ...
        out1 = self.patch_embed3(out)
        out2 = self.patch_embed4(out)
