...
class LLFormer(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        #print("tensor of out:", out_enc_encoder1.shape)
        #print("tensor of out:", out_enc_encoder2.shape)
        #print("tensor of out:", out_enc_encoder3.shape)

        inp_enc_encoder2 = self.patch_embed2(inp_img)
        out_enc_encoder4 = self.encoder_1(inp_enc_encoder2)
        out_enc_encoder5 = self.encoder_2(out_enc_encoder4)
        out_enc_encoder6 = self.encoder_3(out_enc_encoder5)
        ...
        #print("tensor of out:", inp_fusion_123.shape)
        ...
        #print("tensor of out:", out_fusion_123.shape)

        out_fusion_456 = self.layer_fussion(inp_fusion_456)
        out_fusion_456 = self.conv_fuss(out_fusion_456)
        #out_fusion_456 = self.resize2(out_fusion_456)

        out_fusion_123 = out_fusion_123 + out_fusion_456

        inp_enc_level1_0 = Permute_layer2(self.down_1(out_fusion_123))
        #print("tensor of out:", inp_enc_level1_0.shape)
        ...
        out_fusion_123 = self.latent(Permute_layer2(out_fusion_123))


        out = self.coefficient_1_0[0, :][None, :, None, None] * Permute_layer3(out_fusion_123)  + self.coefficient_1_0[1, :][None, :, None, None] *  out_enc_level1_1
        ...
        out_fusion_123 = self.layer_fussion_2(inp_fusion_123)
        out123 = self.conv_fuss_2(out_fusion_123)
        out123 = self.resize3(out123)

        out_4 = self.refinement_1(out2)
        out_5 = self.refinement_2(out_4)
        out_6 = self.refinement_3(out_5)
        ...
        out456 = self.conv_fuss_2(out_fusion_456)
        out456 = self.resize4(out456)

        out = out123 + out456
        print("tensor of out:", out.shape)
